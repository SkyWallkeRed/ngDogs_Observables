...
router.get('/dogs/:filterString*?', (req, res) => {
    let filterString = req.params.filterString;
    res.send(JSON.stringify(
        !filterString ? DOGS : DOGS.filter((dog) => {
            return dog.name.toLowerCase().includes(filterString.toLowerCase());
        })
    ));
});
...
router.put('/dogsWalk/:id', (req, res) => {
